...
<div class="main-body">
	...
	<a href="ssupport.php"> Go back to inbox<br> </a>
	<div class="viewreq">
	<?php
		$id = $_GET['id'];
		...
		while($req=mysql_fetch_assoc($result))
		{
			...
			echo "<strong><br>Status:</strong> ".$req['ssstatus'];
			
			echo "<br></div>";
			
				if ($req['ssstatus'] == 'Pending')
				{
					echo "<center><a href='process5.php?id=$id'><button class='block'>Completed</button></a></center>";
				}
