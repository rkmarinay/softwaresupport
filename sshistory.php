...
<div class="main-body">
	...
	<?php
		...
		$query="SELECT * FROM requests WHERE ictcstatus='Queued' OR ictcstatus='Completed' ORDER BY id DESC";
		...
		{	
			...
			{
			echo "<div class='stat' style='background-color:#4CAF50'><strong>".$row['ssstatus']."</strong></div>";
			}
