		...
		<div class="w3-content">
			<div class="w3-row-padding w3-center w3-margin-top">
				...
				<a href="users.php"> 
					...
					<br><h3>Manage Users</h3><br>
					<img src="users.png" style="width:50%">
					</div>
				</a>
				</div>
				<div class="w3-third">
				...
				<div class="w3-third">
				<a href="generatereport.php?stat=All">
					<div class="w3-card w3-container w3-button" style="min-height:300px;text-decoration:none">
					<br><h3>Generate Report</h3><br>
					<img src="report.png" style="width:50%">
					</div>
				</a>
				</div>
			</div>
