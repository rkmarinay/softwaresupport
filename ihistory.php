...
<div class="main-body">
	...
	<?php
		...
		echo "<form action='ihistory.php?stat={$stat}' method='GET' >";
		...
		if ($stat=='All')
		{
		$query="SELECT * FROM requests WHERE status !='Disapproved' ORDER BY id DESC";
		}
		
		else{
			$query="SELECT * FROM requests WHERE status !='Disapproved' AND ictcstatus='$stat' ORDER BY id DESC";
		}
		...
		{	
			echo "<a href='ihistory.php?stat={$stat}'style='text-decoration:none;'>";
			echo "<div class='rows'>";
